...
export default class Home extends Component { // todo: maybe use timeline to display education or experience

  render() {

    const { name, email, linkedin, github, bio, tags } = this.props.info;
